...
class CreateOrgSectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sys_org_sections', function (Blueprint $table) {
        ...
        Schema::table('sys_org_sections', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sys_org_sections');
    }
}
