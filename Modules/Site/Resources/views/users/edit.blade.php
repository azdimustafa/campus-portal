...
<div class="d-flex">
    <div class="mr-auto p-2"><h1>Edit User</h1></div>
    <div class="p-2">
...
{!! Form::model($user, ['method' => 'PUT','route' => ['site.users.update', $user->id]]) !!}
<div class="card">
    <div class="card-body">
        ...
        @include('site::users._formPartial', ['user' => $user, 'userRole' => $userRole])
