                    ...
                    <table class="{{ config('adminlte.table_light') }}">
                        ...
                        @foreach ($adminAssignments as $admin)
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="sa-warning" data-url="{{ route('faculties.destroy-assignment', $admin->id) }}"><i class="fa fa-trash text-danger"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
                    ...
                    <table class="{{ config('adminlte.table_light') }}">
                        ...
                        @foreach ($secretariatAssignments as $secretariat)
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="sa-warning" data-url="{{ route('faculties.destroy-assignment', $secretariat->id) }}"><i class="fa fa-trash text-danger"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
...
<div class="modal fade" id="modalCreateAdmin" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['faculties.store-admin', $faculty]]) !!}
...
<div class="modal fade" id="modalCreateSecretariat" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['faculties.store-secretariat', $faculty]]) !!}
                <div class="modal-body">
                    <div class="form-group">
